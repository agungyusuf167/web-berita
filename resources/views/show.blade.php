...
<head>
    ...
    <title>{{ $post->title }} - Cempaka News</title>
            ...
            <div class="w-full lg:w-1/3 px-4">
                <div class="sticky top-28 space-y-8">
                    ...
                    <div class="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-8">
                            @forelse($terpopuler as $key => $tp)
                            <a href="{{ route('berita.show', $tp->slug) }}" class="flex items-start gap-4 group">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-gray-400 mt-2 font-bold uppercase tracking-widest">{{ $tp->category }}</p>
                                </div>
                            </a>
                            @empty
    ...
    <footer class="bg-white border-t border-gray-100 py-12">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-gray-400 text-[10px] font-bold tracking-[0.2em] uppercase">
                &copy; {{ date('Y') }} SMKS CEMPAKA. All rights reserved.
            </p>
        </div>
    </footer>
